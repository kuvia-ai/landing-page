  ...
  return (
    <div className="kuvia-landing-page">
      ...
      <div className='kuvia-landing-page-content'>
        <div className={`kuvia-hamburger-menu ${!animate ? '' : expandHamburgerMenu ? 'spinLeft' : 'spinRight'}`}>
          <div className={`kuvia-hamburger-menu-navbar ${expandHamburgerMenu ? 'expand' : 'shrink'}`}>
            <Navbar />
          </div>
          <div
